	...
	<div class="span5">
		<div class="logo">
			<a href="${pageContext.request.contextPath}/index.action">
				<img alt="民之丰" src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.png">
			</a>
		</div>
	</div>
<!-- 	<div class="span9">
					...
					<table>
						...
						<tr>
							...
							<td>
								...
								<span><font color="red" id="passwordCheck"></font></span>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								...
								<span><font color="red" id="repasswordCheck"></font></span>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								...
								<span><font color="red" id="emailCheck"></font></span>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<input id="name" type="text" name="name" class="text" maxlength="200"/>
								<span><font color="red" id="nameCheck"></font></span>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								...
								<span><font color="red" id="phoneCheck"></font></span>
							</td>
						</tr>	
						<tr>
							<th>
							...
							<td>
								<input id="addr" type="text" name="addr" class="text" maxlength="200"/>
								<span><font color="red" id="addrCheck"></font></span>
							</td>
						</tr>
						<tr>
							<th>
						...
						<tr>
							...
							<td>
								<input id="submit" type="submit" class="submit" value="同意以下协议并注册"></input>
							</td>
						</tr>
						<tr>
							<th>&nbsp;		
...
<div class="span24">
		<div class="copyright">Copyright © 2020民之丰农产品商城 版权所有</div>
	</div>
</body>
</html>